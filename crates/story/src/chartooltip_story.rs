...
pub struct ChartooltipStory {
    focus_handle: gpui::FocusHandle,
    monthly_devices: Vec<MonthlyDevice>,
}

impl ChartooltipStory {
...
impl Story for ChartooltipStory {
    fn title() -> &'static str {
        "Tooltip"
    }
...
impl Focusable for ChartooltipStory {
...
fn chart_container(
    ...
    center: bool,
    cx: &mut Context<ChartooltipStory>,
) -> impl IntoElement {
    v_flex()
        .flex_1()
        .h_full()
...
impl Render for ChartooltipStory {
    fn render(
        &mut self,
        _: &mut gpui::Window,
